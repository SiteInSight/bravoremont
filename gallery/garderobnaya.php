				...
				<div class="fsFilter-property-options block_komnata" filter_id="130">
					<ul>
						...
						<li ><label for="komnata2"><i class="checkbox"><input type="checkbox"   id="komnata2" link="vannaya" text="Ванная" onchange="select_option(false,'komnata','komnata2');"><label></label></i>
								...
								<span>Наружная отделка</span></a><input type="hidden" id="hidden_komnata13" link="narujnaya-otdelka" text="Наружная отделка"></label></li><li ><label for="komnata14"><i class="checkbox"><input type="checkbox" checked  id="komnata14" link="garderobnaya" text="Гардеробная" onchange="select_option(false,'komnata','komnata14');"><label></label></i>
...
<input type="hidden" id="unit_hidden" value="garderobnaya">
<input type="hidden" id="material_hidden" value="garderobnaya">
...
<div class="footer2-stats">
            <span><b>57</b> человек сейчас на сайте вместе с Вами</span>
