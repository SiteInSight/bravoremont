...
<head>
<title>Ремонт лоджий под ключ в Минске - фото и цены</title>
<meta name="description" content="Выполним весь комплекс работ по ремонту лоджий в Минске и Минской области. Опытные специалисты и низкие цены на все виды работ. Рассрочка."/>
...
<h1 id="title_h1">Ремонт лоджий</h1>
				...
				<div class="fsFilter-property-options block_komnata" filter_id="130">
					<ul>
						...
						<li ><label for="komnata2"><i class="checkbox"><input type="checkbox"   id="komnata2" link="vannaya" text="Ванная" onchange="select_option(false,'komnata','komnata2');"><label></label></i>
								...
								<span>Коридор</span></a><input type="hidden" id="hidden_komnata8" link="koridor" text="Коридор"></label></li><li ><label for="komnata9"><i class="checkbox"><input type="checkbox" checked  id="komnata9" link="lodjiya" text="Лоджия" onchange="select_option(false,'komnata','komnata9');"><label></label></i>
...
<input type="hidden" id="unit_hidden" value="lodjiya">
<input type="hidden" id="material_hidden" value="lodjiya">
...
<p>Ремонт балконов и лоджий сегодня – вопрос творческий. Сейчас настало время, когда эта часть квартиры уже не используется в качестве огромного хранилища. Часто эту площадь присоединяют к общему пространству комнаты, поэтому утепление – одна из важнейших задач при проведении работ.</p>

<p>Ремонт балконов и лоджий включает следующие этапы:</p>

<ul>
<li>установка надежных стеклопакетов;</li>
<li>утепление с помощью обычных материалов или электрических систем;</li>
<li>отделка помещения вагонкой или панелями.</li>
</ul>

<p>Ремонтные работы в этом помещении требуют навыков и умений, которые есть только у специалистов. Самостоятельно подобрать материалы и провести подготовительные работы сложно, а если где-то допустить ошибку – то можно остаться, например, с протекающим балконом.</p>

<p>Разработка дизайна помещения – также немаловажная задача. Дизайнер создаст необычный образ и наполнит помещение оригинальными деталями. С помощью профессионалов устроить на балконе летнюю беседку или место для дружеских встреч можно легко и быстро.</p>

<p>Кроме того, в список ремонтных работ входят также установка электропроводки, монтаж светильников и розеток, установка конструкций и вспомогательных элементов. Качественно выполнить все эти задачи под силу только настоящим мастерам. </p>
</div>
...
<div class="footer2-stats">
            <span><b>73</b> человека сейчас на сайте вместе с Вами</span>
