...
<head>
<title>Элитный ремонт квартир премиум класса в Минске - фото и цены</title>
<meta name="description" content="Выполним ремонт вашей квартиры с использованием самых дорогих и элитных материалов. Большой опыт ремонта квартир премиум класса."/>
...
<h1 id="title_h1">Ремонт квартир премиум класса</h1>
...
<div class="width100 endFloat fs-container main">
	...
	<!-- ФИЛЬТРЫ-->
		...
		<div class="fsFilter-row">
				...
				<div class="fsFilter-property-link ">Комната</div>
				<div class="fsFilter-property-options block_komnata" filter_id="130">
					<ul>
						<li li_all>
							<label for="komnata1"><i class="checkbox" ><input type="checkbox" checked id="komnata1" onchange="select_option(true,'komnata','komnata1');"><label></label></i>
				...
				<div class="fsFilter-property-link used">Класс</div>
				<div class="fsFilter-property-options block_class_global" filter_id="37">
					<ul>
						<li li_all>
							<label for="class_global1"><i class="checkbox" ><input type="checkbox"  id="class_global1" onchange="select_option(true,'class_global','class_global1');"><label></label></i>
								<a href="https://remont.nebo.by/gallery/" onclick="click_link(this);event.preventDefault();"><span>Все</span></a></label>
						</li>
						...
						<li ><label for="class_global2"><i class="checkbox"><input type="checkbox"   id="class_global2" link="standard" text="Стандарт" onchange="select_option(false,'class_global','class_global2');"><label></label></i>
								...
								<span>Стандарт</span></a><input type="hidden" id="hidden_class_global2" link="standard" text="Стандарт"></label></li><li ><label for="class_global3"><i class="checkbox"><input type="checkbox" checked  id="class_global3" link="premium" text="Премиум" onchange="select_option(false,'class_global','class_global3');"><label></label></i>
...
<input type="hidden" id="unit_hidden" value="premium">
<input type="hidden" id="material_hidden" value="premium">
...
<p>Элитный ремонт квартир предполагает разработку оригинального проекта с применением дорогих строительных материалов.
В задачи по элитному ремонту квартир входит:</p>

<ul>
<li>выбор и укладка напольного покрытия. Выбираются экологичные материалы – дорогой паркет или натуральная доска. Для получения необычного фактурного рисунка можно выбрать редкие породы дерева. Под напольное покрытие лучше уложить систему теплых полов;</li>
<li>отделка стен. Среди материалов для необычной отделки можно выбрать обои из натуральных составляющих (бамбук, пробка), декоративные штукатурки и краски, мозаику, а также оформление стен с помощью ткани (бархат, парча). Все материалы отличаются экологичностью и безопасностью;</li>
<li>монтаж потолка. Для получения индивидуального облика лучше выбирать натяжной потолок с аэрографией или многоуровневые конструкции;</li>
<li>ванная комната. Применение эксклюзивной сантехники и необычного освещения способно превратить обычное помещение в произведение искусства;</li>
<li>услуги декорирования. В дополнение к отделочным работам дизайнер поможет подобрать соответствующую мебель и аксессуары.</li>
</ul>

<p>Элитная отделка гарантирует то, что проект будет единственным и неповторимым. </p>
</div>
...
<div class="footer2-stats">
            <span><b>67</b> человек сейчас на сайте вместе с Вами</span>
