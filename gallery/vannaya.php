...
<head>
<title>Ремонт ванной комнаты под ключ в Минске - цены и фото</title>
<meta name="description" content="Оказываем услуги по ремонту и отделке ванных комнаты под ключ в Минске. Возможно оплата в рассрочку. Договор и гарантия. Профессиональные отделочники."/>
...
<script type="text/javascript" src="https://content.nebo.by/template/js/forms/inputmask.js"></script>
<script type="text/javascript" src="https://content.nebo.by/template/js/forms/jquery.inputmask.js"></script>
<script type="text/javascript" src="https://content.nebo.by/template/js/forms/forms.js"></script>

<div class="width100 endFloat">
    <div class="width1600 product_banner endFloat">
		<div  class="product_banner-picture">
			<picture>
			<source media="(max-width:860px)" srcset="https://remont.nebo.by/img/about_product/remont-vannoi-m.jpg">
			<img src="https://remont.nebo.by/img/about_product/remont-vannoi.jpg"/>
			</picture>
		</div>
		<div  class="product_banner-content">
            <script  type="text/javascript" src="https://content.nebo.by/template/js/forms/inputmask.min.js"></script><script  type="text/javascript" src="https://content.nebo.by/template/js/forms/jquery.inputmask.min.js"></script><script  type="text/javascript" src="https://content.nebo.by/template/js/forms/forms_new.min.js"></script><!--<script type="text/javascript" src="https://content.nebo.by/template/js/forms/inputmask.js"></script>
<script type="text/javascript" src="https://content.nebo.by/template/js/forms/jquery.inputmask.js"></script>
<script type="text/javascript" src="https://content.nebo.by/template/js/forms/forms_new.js"></script>
-->
<form action="javascript:void(null);" method="post" enctype="multipart/form-data" onsubmit="$(this).find('.toOrder_form').addClass('sent');toOrderSend($(this));">
    <input type="hidden" name="action" value="toOrderSend">
    <input type="hidden" name="toOrderId" value="">
    <input type="hidden" name="toOrderURL" value="/gallery/vannaya.php">
    <input type="hidden" name="toOrderREFERER" value="https://remont.nebo.by/">

    <div class="toOrder_form product_banner_info" >
        <input type="hidden" class="phone_ok" value="0"/>
        <div class="resetable">
            <div class="product_banner_info_title"><span></span></div>
            <div class="product_banner_info_input endFloat"><span>Введите Ваше имя</span><input class="who" name="toOrderName" type="text" onkeyup="ucfirst($(this));" aria-label="Введите ваше имя"/></div>
            <div class="product_banner_info_input endFloat"><span>Введите Ваш телефон</span><input class="us_mobile" name="toOrderPhone" value="" required  aria-label="Введите ваш телефон"/></div>
        </div>
        <div class="toOrderSend"><button class="cta-primary" disabled>Заказать</button></div>
    </div>

    <div class="toOrder_form_sentStatus product_banner_info">
        <div class="product_banner_info_title"><span>Отправлено! Мы скоро позвоним Вам.</span></div>
    </div>
 ...
 <h1>Расчет стоимости ремонта ванной</h1>

<script type="text/javascript" src="https://remont.nebo.by/js/calculator.js"></script>


<div class="calc-wrapper silver endFloat m_lr2_padding">
<div class="calc-container endFloat">

	<div class="calc-data">
	
		<div class="calc-line">
			<div class="calc-line-desc">
				<span>Общая площадь</span>
				<span class="tooltip left"  tabindex="0">
					<p>?</p>
					<span>Укажите общую площадь помещений, в которых будет осуществляться ремонт</span>
				</span>
			</div>
					
			<div class="calc-line-inp">
				<input  type="text" autocomplete="off" id="metraj" maxlength="10" value="0" onfocus=" if(this.value == 0) this.value='';" onblur=" if(this.value == '') this.value='0'; " onkeyup="calculate();"  aria-label="Укажите общую площадь помещений"/>
				<div class="calc-line-unit">
		...
		<div class="calc-line">
			<div class="calc-line-desc">
				...
				<span class="tooltip left"  tabindex="0">
					<p>?</p>
					<span>От типа ремонта зависит набор включенных в стоимость услуг</span>
				</span>
			</div>
					
			<div class="calc-line-sel">
				<select id="repair_type" onchange="calculate(); get_tooltip(this);" aria-label="Укажите тип ремонта квартиры">
									<option id_option="99" value="55">Косметический</option>
				
									<option id_option="100" value="95">Капитальный</option>
				
									<option id_option="101" value="125">Премиум ремонт</option>
				
									<option id_option="102" value="70">Ремонт офиса</option>
				
									<option id_option="103" value="450">Только ванная и туалет</option>
				
				
				</select>
				<span class="tooltip left" style="margin-top: 8px; margin-left: 5px; display:none;"  tabindex="0">
					<p>i</p>
					<span></span>
				</span>
			</div>
		...
		<div class="calc-line">
			<div class="calc-line-desc">
				...
				<span class="tooltip left"  tabindex="0">
					<p>?</p>
					<span>Укажите тип жилого дома</span>
				</span>
			</div>
					
			<div class="calc-line-sel">
				<select id="house_type" onchange="calculate(); get_tooltip(this);" aria-label="Укажите тип жилого дома">
										<option id_option="358" value="100">Панельный или кирпичный</option>
				
									<option id_option="359" value="110">Монолитный или каркасно-блочный</option>
				
									<option id_option="360" value="115">"Хрущевка" или "Сталинка"</option>
	...
	<div class="calc-total">
		...
		<input id="currency_usd" type="hidden" value="2.2000" />
		
		<div class="calc-total-desc">
			<span>Итого<i>*</i>:</span>
		</div>
				
		<div class="calc-total-sum">
			<span id="calc-total-final">0</span>
			<span>руб.</span>
	...
	<div class="remark">
		<p>Стоимость ориентировочная. Точная стоимость может быть просчитана только после выезда мастера на объект и составления сметы. Предложение не является публичной офертой. Ремонт можно заказать в беспроцентную рассрочку на срок до 12 месяцев.</p>
	</div>
...
<h1 id="title_h1">Ремонт ванной под ключ</h1>
		...
		<div class="fsFilter-row">
				...
				<div class="fsFilter-property-options block_komnata" filter_id="130">
					<ul>
						...
						<li ><label for="komnata2"><i class="checkbox"><input type="checkbox" checked  id="komnata2" link="vannaya" text="Ванная" onchange="select_option(false,'komnata','komnata2');"><label></label></i>
								...
								<span>Детская</span></a><input type="hidden" id="hidden_komnata10" link="detskaya" text="Детская"></label></li><li ><label for="komnata11"><i class="checkbox"><input type="checkbox"   id="komnata11" link="balkon" text="Балкон" onchange="select_option(false,'komnata','komnata11');"><label></label></i>
...
<input type="hidden" id="unit_hidden" value="vannaya">
<input type="hidden" id="material_hidden" value="vannaya">
...
<h2>В стоимость отделки ванной входит</h2>

	<ul>
		<li>Ремонт и отделка потолка и стен
			<ul>
				<li>Очистка старого покрытия (удаление обоев,плитки, краски и шпаклёвки), демонтаж подвесной системы</li>
				<li>Грунтовка и полная шпаклевка шпаклевка (подготовка под облицовочные работы)</li>
				<li>Укладка новой плитки</li>
			</ul>
		</li>
		<li>Ремонт и отделка пола
			<ul>
				<li>Демонтаж старого напольного покрытия</li>
				<li>Монтаж гидроизоляционного слоя</li>
				<li>Укладка плитки</li>
			</ul>
		</li>
		<li>Ремонт или замена инженерных коммуникаций
			<ul>
				<li>Разводка труб от стояков</li>
				<li>Водоснабжение и канализационная система</li>
				<li>Установка фильтров, редукторов, гребенок</li>
			</ul>
		</li>
		<li>Установка ванны, унитаза, раковины, полотенцесушителя, а также подключение стиральной машины</li>

		<li>Установка сантехнических приборов, ванных шкафчиков</li>
		<li>Любые электромонтажные работы</li>
...
<ul>
		...
		<li>Вывоз строительного мусора с объекта</li>

</ul>
	
<div class="remark">
<p>Услуги, не входящие в стоимость, можно по договоренности заказать отдельно и также включить в смету</p>
</div>	
        

<p>Ремонт ванной комнаты начинаем с закупки материала. Сделав расчет нужного количества плитки в квадратных метрах  или штуках, добавьте к  нему еще 5%. Этот  запас делают с учетом того, что плитку нужно будет резать, а значит,  будут отходы. После укладки всей плитки, небольшое количество ее должно остаться на случай возможного ремонта. Количество готовой смеси ориентировочно берут из расчета 8 кг на один квадратный метр. </p>
<p>Старую штукатурку отбиваем до кирпича или бетона. Необходимо тщательно убрать всю пыль  и грязь со стен и потолка. </p>
<p>Следующий этап – обязательно покрываем стены ванной комнаты грунтовкой. </p>
<p>Затем приступаем к процессу выравнивания стен. Должны получиться идеально ровные плоскости стен, после нанесения штукатурки. Между стенами угол должен быть 90 градусов. Путем приложения к стене ровной рейки в разных направлениях определяем места выступов и впадин. Если перепад  между ними не большой, до 1 см, то ставим рейку вертикально, отступив от угла 15 – 20 см. Вверху под рейкой  и внизу сверлим отверстия, и вставляем в них пластмассовые пробки, и вкручиваем в них винты. Прислонив рейку к  винтам, добиваемся при помощи уровня  ее вертикального положения. Зазор между рейкой и стеной должен быть минимальным. Желательный зазор – до 1 см не больше. Между верхним и нижним винтами устанавливают еще 2 – 3 винта. На уровне этих винтов делаем пятна из гипса и даем им высохнуть. Затем соединяем эти  места, и получаем полосу из гипса.  Вторую полосу, отступив от первой 0.7 – 1 м выполняют так, чтобы плоскость, полученная от двух полос,  составляла 90 градусов от пересечения с плоскостью смежной стены. Для этого используют большой угольник 90 градусов. Получив вторую полосу из гипса, третью получаем в уровень с первыми двумя путем приложения рейки на полосы. Когда полосы высохнут, можно продолжать ремонт ванной комнаты и туалета и штукатурить, используя рейку, которую двигают по полосам, как по направляющим, распределяя  нанесенный раствор.</p>
<p>Плитку начинают укладывать со второго ряда снизу. При помощи рейки и уровня натяните горизонтально шнур и по нему уложите первый ряд. Толщину швов между плитками фиксируют с помощью специальных вставок. Проверяйте вертикальность каждой плитки и нахождение плиток  в одной плоскости.  Последний нижний ряд укладывают  после того, как уложена плитка пола. </p>
<p>Режут плитку стеклорезом. Вырезы под трубы выполняют специальным лобзиком.</p>
<p>На этом отделка в ванной комнате не заканчивается. Когда плитка уложена, спустя несколько дней заполняют швы специальными цветными составами. При этом используют резиновые и металлические шпатели.</p>
<p>Укладывая  плитку на пол, используя рейку и уровень, отбивают по всем стенам уровень чистого пола (проводят по стенам горизонталь, соответствующую уровню будущего пола). Отступают от стены на ширину плитки и натягивают шнур. По шнуру укладывают первый ряд. Положив рейку сверху плитки, проверяем, чтобы все плитки лежали в одной плоскости. Также вставками в швы контролируем зазоры между уложенными плитками. Затем опять натягиваем  шнур и укладываем следующий ряд и т.д.</p>
<p>Через несколько  дней, после укладки плитки на пол затираем швы. Перед работой плитку предварительно на 3-4 сек опускают в воду. После укладки каждую плитку  вытирают губкой. Ремонт в ванной и туалете почти закончен! Осталось повесить ванные шкафчики, установить полотенцесушитель и другие мелочи.</p>


<div class="linked_box">
<div>Смотрите также:</div>
<li><a href="https://steklo.nebo.by/steklyannye-dushevye-kabiny.php">Стеклянные душевые кабины цены</a></li>
<li><a href="https://remont.nebo.by/gallery/kuhnya.php">Ремонт на кухне</a></li>
<li><a href="https://nebohouse.ru">Мебель под заказ в Москве</a></li>
</div></div>
...
<div class="footer2-stats">
            <span><b>72</b> человека сейчас на сайте вместе с Вами</span>
